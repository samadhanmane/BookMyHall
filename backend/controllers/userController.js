...
const bookAppointment = async (req, res) => {
    try {
        ...
        // Add all booked slots
        slots_booked[slotDate].push(...timeSlots);
        ...
        Promise.all([
            sendEmail({
                to: hall.email,
                subject: 'New Booking Request - BookMyHall',
                html: getHallBookingConfirmationTemplate(userData, hall, slotDate, slotTime)
            }),
            sendEmail({
                to: userData.email,
                subject: 'Booking Confirmation - BookMyHall',
                html: getBookingConfirmationTemplate(userData, hall, slotDate, slotTime)
            })
        ]).catch(error => {
