...
const DEMO_ACCOUNTS: DemoAccount[] = [
  ...
  },
  {
    ...
    group: 'Administration',
    description: 'Tenant Administrator (facilities, users, analytics)',
  },
  {
    id: 'director',
    role: 'Director',
  ...
  },
  {
    ...
    group: 'Academics & Department',
    description: 'Department Assistant / Staff member',
  },
  {
    id: 'workshop_hod',
    role: 'Workshop HOD',
    email: 'workshophod@demo.com',
    group: 'Operations & Maintenance',
    description: 'Central Workshop Head (assigns maintenance tickets)',
  },
  {
    id: 'worker',
    role: 'Workshop Technician / Worker',
  ...
  {
    id: 'canteen_owner',
    role: 'Canteen Owner / Manager',
    email: 'canteen@demo.com',
    group: 'Operations & Maintenance',
    description: 'Canteen Manager (food orders, menus & fulfillment)',
  },
  {
    id: 'student',
    role: 'Student',
    email: 'student@demo.com',
    group: 'Students & Support',
    description: 'Student (view campus halls, utilities & schedules)',
  },
];
