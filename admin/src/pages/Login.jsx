    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            if (data.success) {
                ...
                // Make sure the token is a string and properly formatted
                const tokenToStore = data.token.toString().trim();
                console.log('Token to store:', { 
                    length: tokenToStore.length,
                    preview: tokenToStore.substring(0, 20) + '...'
                });
                
                localStorage.setItem(tokenKey, tokenToStore);
                state === 'Admin' ? setAToken(tokenToStore) : setDToken(tokenToStore);
