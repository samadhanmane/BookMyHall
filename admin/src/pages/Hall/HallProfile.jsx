...
const HallProfile = () => {
  ...
  // Fetch vehicles for the manager
  const fetchVehicles = async () => {
    try {
      ...
      if (response.data.success) {
        const filteredVehicles = response.data.halls.filter(hall => hall.isVehicle);
  ...
  // Fetch guest rooms, halls, and vehicles when profile data is available
  useEffect(() => {
    if (profileData) {
      fetchGuestRooms();
      fetchHalls();
                  ...
                  {editingRoom === vehicle._id ? (
                    ...
                    <>
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          <p className="text-gray-600">{vehicle.about || 'No description available'}</p>
                        </div>
                        <div className="text-sm text-gray-500">
                          <p>Address:</p>
